...
@section('content')
    ...
    @php
        $selectedPayment = session('purchase_payment_method_' . $item->id);
    @endphp
                ...
                <div class="purchase-left">
                    ...
                    <div class="purchase-section">
                        ...
                        <select name="payment_method" id="payment-method" class="payment-select">
                            ...
                            <option value="1" {{ $selectedPayment == 1 ? 'selected' : '' }}>
                                コンビニ払い
                            </option>

                            <option value="2" {{ $selectedPayment == 2 ? 'selected' : '' }}>
                                カード払い
                            </option>
                        </select>
